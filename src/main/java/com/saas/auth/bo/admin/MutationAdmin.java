...
@Type
@Component("Admin.MutationAdmin")
public class MutationAdmin extends BOBase {
	...
	@Field
	public String buildBindAdminStr(@Var("mobileno") String mobileno, @Var("nickname") String nickname)throws Exception {
	...
	@Field
	public AdminSession login4WX(@Var("code") String wxcode)throws Exception{
	...
	public boolean updateAdmin(@Var("params") AdminParam params)throws Exception{
		...
		params.setAdminId(session.getAdminId());
